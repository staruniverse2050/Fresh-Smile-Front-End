              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="about-move">
                  <div class="services-details">
                    <div class="single-services">
                      <img
                        src="public/BLANQUEAMIENTO-DENTAL.jpg"
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class=" about-move">
                  <div class="services-details">
                    <div class="single-services">
                      <img
                       src="public/DISEÑO-DE-SONRISA.jpg"
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class=" about-move">
                  <div class="services-details">
                    <div class="single-services">
                      <img
                        src="public/LIMPIEZA-DENTAL.jpg"
                        alt="Limpieza Dental"
                        class="card-img"
                      />
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class=" about-move">
                  <div class="services-details">
                    <div class="single-services">
                      <img
                        src="public/DISEÑO-DE-CAJA.jpg"
                        alt="Diseño de caja"
                        class="card-img"
                      />
                      <h4>Diseño de caja</h4>
                      <p>
                        will have to make sure the prototype looks finished by
                        inserting text or photo.make sure the prototype looks
                        finished by.
