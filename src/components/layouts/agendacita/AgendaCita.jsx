          ...
          <form onSubmit={handleSubmit}>
            <div className='schedule-input'>
              ...
              <div className="input-container">
                <input type="text" id="disease1" value={disease1} onChange={(e) => setDisease1(e.target.value)} required/>
                <span onClick={() => document.getElementById("disease1").focus()}>Enfermedad A</span>
              </div>
              <div className="input-container">
                <input type="text" id="disease2" value={disease2} onChange={(e) => setDisease2(e.target.value)} required/>
                <span onClick={() => document.getElementById("disease2").focus()}>Enfermedad B</span>
              </div>
            </div>
            <div className='schedule-input'>
              <label htmlFor="allergy">Alergias:</label>
              <div className="input-container">
                <input type="text" id="allergy1" value={allergy1} onChange={(e) => setAllergy1(e.target.value)} required/>
                <span onClick={() => document.getElementById("allergy1").focus()}>Alergia A</span>
              </div>
              <div className="input-container">
                <input type="text" id="allergy2" value={allergy2} onChange={(e) => setAllergy2(e.target.value)} required/>
                <span onClick={() => document.getElementById("allergy2").focus()}>Alergia B</span>
              </div>
            </div>
            <div className='schedule-input'>
              <label htmlFor="medicine">Medicamentos:</label>
              <div className="input-container">
                <input type="text" id="medicine1" value={medicine1} onChange={(e) => setMedicine1(e.target.value)} required/>
                <span onClick={() => document.getElementById("medicine1").focus()}>Medicina A</span>
              </div>
              <div className="input-container">
                <input type="text" id="medicine2" value={medicine2} onChange={(e) => setMedicine2(e.target.value)} required/>
                <span onClick={() => document.getElementById("medicine2").focus()}>Medicina B</span>
              </div>
            </div>
            {/* <div className='schedule-input'>
