    ...
    <>
      ...
      <div className="contenedor-procedimientos">
        <div className="card-procedimientos">
          <img src="https://res.cloudinary.com/smilecmills/image/upload/v1683852202/Fresh_Smile_Cmills/carillas_hbazmk.jpg" alt="Imagen de la tarjeta" />
        ...
        <div className="card-procedimientos">
          <img src="https://res.cloudinary.com/smilecmills/image/upload/v1683852210/Fresh_Smile_Cmills/implantes_keq38a.jpg" alt="Imagen de la tarjeta" />
          <div className="contenido-procedimientos">
            <h2>Implantes Dentales</h2>
        ...
        <div className="card-procedimientos">
          <img src="https://res.cloudinary.com/smilecmills/image/upload/v1683852210/Fresh_Smile_Cmills/implantesss_deur5s.jpg" alt="Imagen de la tarjeta" />
          <div className="contenido-procedimientos">
            <h2>Prótesis Dental</h2>
        ...
        <div className="card-procedimientos">
          <img src="https://res.cloudinary.com/smilecmills/image/upload/v1683852212/Fresh_Smile_Cmills/cards1_s5fs46.jpg" alt="Imagen de la tarjeta" />
          <div className="contenido-procedimientos">
            <h2>Cirugía Oral</h2>
        ...
        <div className="card-procedimientos">
          <img src="https://res.cloudinary.com/smilecmills/image/upload/v1684268627/Fresh_Smile_Cmills/jonathan-borba-v_2FRXEba94-unsplash_cth93o.jpg" alt="Imagen de la tarjeta" />
          <div className="contenido-procedimientos">
            <h2>Extracción de Muelas del Juicio</h2>
        ...
        <div className="card-procedimientos">
          <img src="https://res.cloudinary.com/smilecmills/image/upload/v1684269551/Fresh_Smile_Cmills/caroline-lm-8BkF0sTC6Uo-unsplash_efkumb.jpg" alt="Imagen de la tarjeta" />
          <div className="contenido-procedimientos">
            <h2>Limpieza Dental Profunda</h2>
        ...
        <div className="card-procedimientos">
          <img src="https://res.cloudinary.com/smilecmills/image/upload/v1684268377/Fresh_Smile_Cmills/jonathan-borba-W9YEY6G8LVM-unsplash_qpfaed.jpg" alt="Imagen de la tarjeta" />
          <div className="contenido-procedimientos">
            <h2>Coronas Dentales</h2>
        ...
        <div className="card-procedimientos">
          <img src="https://res.cloudinary.com/smilecmills/image/upload/v1684268332/Fresh_Smile_Cmills/enis-yavuz-4u2fG9mqGvQ-unsplash_saf7yd.jpg" alt="Imagen de la tarjeta" />
          <div className="contenido-procedimientos">
            <h2>Ortodoncia</h2>
        ...
        <div className="card-procedimientos">
          <img src="https://res.cloudinary.com/smilecmills/image/upload/v1683852203/Fresh_Smile_Cmills/endodoncia_n1qzcw.png" alt="Imagen de la tarjeta" />
          <div className="contenido-procedimientos">
            <h2>Endodoncia</h2>
